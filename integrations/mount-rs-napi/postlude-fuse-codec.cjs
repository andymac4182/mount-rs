...
function install(binding) {
  ...
  for (const [publicName, nativeName] of [
    ...
    ["decodeLookupIn", "fuseDecodeLookupIn"], ["encodeLookupIn", "fuseEncodeLookupIn"],
    ["decodeLookupOut", "fuseDecodeLookupOut"], ["encodeLookupOut", "fuseEncodeLookupOut"],
    ["decodeSymlinkIn", "fuseDecodeSymlinkIn"], ["encodeSymlinkIn", "fuseEncodeSymlinkIn"],
    ["decodeSymlinkOut", "fuseDecodeSymlinkOut"], ["encodeSymlinkOut", "fuseEncodeSymlinkOut"],
    ["decodeMknodIn", "fuseDecodeMknodIn"], ["encodeMknodIn", "fuseEncodeMknodIn"],
    ["decodeMknodOut", "fuseDecodeMknodOut"], ["encodeMknodOut", "fuseEncodeMknodOut"],
    ["decodeMkdirIn", "fuseDecodeMkdirIn"], ["encodeMkdirIn", "fuseEncodeMkdirIn"],
    ["decodeMkdirOut", "fuseDecodeMkdirOut"], ["encodeMkdirOut", "fuseEncodeMkdirOut"],
    ["decodeUnlinkIn", "fuseDecodeUnlinkIn"], ["encodeUnlinkIn", "fuseEncodeUnlinkIn"],
    ["decodeRmdirIn", "fuseDecodeRmdirIn"], ["encodeRmdirIn", "fuseEncodeRmdirIn"],
    ["decodeRenameIn", "fuseDecodeRenameIn"], ["encodeRenameIn", "fuseEncodeRenameIn"],
    ["decodeRename2In", "fuseDecodeRename2In"], ["encodeRename2In", "fuseEncodeRename2In"],
    ["decodeLinkIn", "fuseDecodeLinkIn"], ["encodeLinkIn", "fuseEncodeLinkIn"],
    ["decodeLinkOut", "fuseDecodeLinkOut"], ["encodeLinkOut", "fuseEncodeLinkOut"],
    ["decodeAccessIn", "fuseDecodeAccessIn"], ["encodeAccessIn", "fuseEncodeAccessIn"],
    ...
    ["decodeSyncfsIn", "fuseDecodeSyncfsIn"], ["encodeSyncfsIn", "fuseEncodeSyncfsIn"],
    ...
    ["decodeFallocateIn", "fuseDecodeFallocateIn"], ["encodeFallocateIn", "fuseEncodeFallocateIn"],
    ["decodeLseekIn", "fuseDecodeLseekIn"], ["encodeLseekIn", "fuseEncodeLseekIn"],
    ["decodeLseekOut", "fuseDecodeLseekOut"], ["encodeLseekOut", "fuseEncodeLseekOut"],
