...
pub use sigv4::{
    ...
    PresignedRequest, QueryEntry, STREAMING_PAYLOAD, SigV4Failure, SignRequest, UNSIGNED_PAYLOAD,
    VerifyRequest, canonical_query, canonical_request, format_amz_date, presign_request,
    sha256_hex, sign_chunk, sign_request,
};
