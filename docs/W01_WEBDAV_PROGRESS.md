...
| Session, lock, auth and streaming objects | Buffered/session, active-lock readback, and direct streaming slices PASS; member parity OPEN | N-API session view, driver/options/lock policy, active lock records, class 1/2 methods, auth challenge/acceptance, streamed bodies, cancellation, and typed errors |
