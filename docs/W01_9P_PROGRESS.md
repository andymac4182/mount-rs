...
- The mixed native/attached client-order packet is implemented at exact SHA
  `57a6063c295877d0223c911da11a2c4621c06798`. Its real-TCP regression covers
...
- The mounted-view identity packet is implemented at exact SHA
  `0a156530af4fba6d33081a5a2810a4833907876e`. The N-API postlude caches
