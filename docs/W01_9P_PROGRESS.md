...
| Linux native 9P | Hosted prior lifecycle PASS; current packet unqualified | CI run `35616832528`, job `106389895603`, at `e168315c246061926a36e795f7332831cb1ab62f` passed `modprobe 9p`, `modprobe 9pnet_fd`, and both privileged ignored native mount/read/write/unmount lifecycle tests; the current shutdown/reaping, bounded concurrent file-I/O, and server-close packet has not executed in a hosted job |
