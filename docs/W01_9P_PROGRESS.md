...
| Attached-stream contract | Local + hosted N-API PASS for the covered lifecycle slice | Node `attach(stream, options)` with typed peer/ownership/frame/in-flight bounds, ownership, duplicate attach, direct session calls, non-socket duplex, backpressure, write failure, and server-close tests; exact SHA `007e6545d1b25d708abfa10f2120f81fba59a74a` passed the isolated hosted N-API server/attached-stream lifecycle step in [Native 9P run `35682638941`](https://github.com/andymac4182/mount-rs/actions/runs/35682638941), job `106602684115` |
...
- Keep the isolated `MOUNT_RS_SERVER_PHASE=p9` N-API step as the server and
  ...
  write-fault teardown, and server close without being masked by the unrelated
  Darwin NFS relisten phase. Exact SHA `007e6545d1b25d708abfa10f2120f81fba59a74a`
  passed this step in hosted job `106602684115` of [run `35682638941`](https://github.com/andymac4182/mount-rs/actions/runs/35682638941).
