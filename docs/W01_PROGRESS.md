...
direct LOCK/UNLOCK check observes one record and then zero. Complete
session/member parity, direct listener lifecycle, and the external
provider/native/restart gates remain open.
