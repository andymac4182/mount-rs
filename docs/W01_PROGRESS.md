...
direct `MountP9Options` audit found no additional unrepresented fields;
automatic cross-transport signal ownership, supervisor-owned
crash/reset/half-close recovery, and other W01 gates remain open, so the
