...
host-enabled macOS run passed 1/1 with the shared Cargo wrapper; hosted
macOS/Linux jobs in CI `35676711711` passed the preceding eight-way harness,
but hosted qualification of the new teardown/restart extension remains
required.
