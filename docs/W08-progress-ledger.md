...
Current published tip: `origin/main` at `7dd004e` (the W08 evidence chunk was
...
| 2026-09-21 21:44–21:56 AEST | Followed current-main CI run `35595664981`, extracted terminal `tidb-rustfs` job `106319766691` markers, committed the evidence update as `67e0938`, reconciled concurrent main changes and published the result at `7dd004e`. | ~5 min | ~10 min hosted/remote wait | Both seed and reopen bounded soak phases passed with zero errors and recorded latency/throughput metrics. W08.8 bounded hosted qualification is complete; P06 remains open for production-shaped workload, resource/headroom, failover, multi-hour and SLO/cost evidence. |
