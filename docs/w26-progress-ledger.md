...
| Current-head CI attempt | The provider-matrix chunk has not yet been pushed, so no hosted result exists for it. Earlier runs for `b997696` remain non-terminal evidence; the retained W26 packet above remains the last accepted hosted result. |
