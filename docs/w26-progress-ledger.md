...
| Repository | `mount-rs` |
| Snapshot base | `f3aae7d` (latest published origin/main head carrying the W26 evidence-packet verifier, retained acceptance logs, fail-closed artifact/profile checks and concurrent mainline changes; its current CI attempt was canceled before jobs started and is not evidence) |
