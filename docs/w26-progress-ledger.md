...
| Field | Current value |
| --- | --- |
| Shared build-on tip | `origin/main` = `5e3680117c26f5b7bb1b9280eec65a350b3dd2f7`, verified with `git ls-remote`; the worktree is clean. This is the exact code tip other W26 threads should build on. |
