...
| Repository | `mount-rs` |
| Snapshot base | `43f8df2` (current `origin/main` after the TiDB Ozone Node/N-API bounded-listing qualification and concurrent mainline changes; current hosted workflows are pending, in progress or failed and are not evidence) |
...
| Current-head CI attempt | Published tip `43f8df2` has CI run `35618625300` pending, Fault injection run `35618625071` pending, W08 release targets run `35618625138` pending, W08 release policy run `35618625062` in progress and Live Cloudflare R2 run `35618625099` failed; no Live AWS S3 run was recorded for this tip. No pending, in-progress or failed run is promoted to evidence; the retained W26 packet above remains the last accepted hosted result. |
