...
| Repository | `mount-rs` |
| Snapshot base | `b237a6f1` (current origin/main before this ledger publication; it carries the W26 evidence-packet verifier, complete-surface marker checks, metric-integrity checks, credential-free rollout contract and concurrent mainline changes; no matching current-tip hosted W26 result is promoted) |
...
| Current acceptance state | The retained W26 packet on `9c098e5` remains the last accepted hosted result within its documented provider/platform boundaries. The newer provider-bounded KV/N-API implementation, unstorage parity fixtures, provider-specific bounded-listing assertions, strict provider-configuration qualification, fail-closed IOPS artifact/profile/metric verification and retention policy, credential-free all-provider production-config policy, complete evidence-packet verifier, complete end-to-end surface marker gate and credential-free customer rollout contract are locally green, syntax-checked or compile-checked. The full locked workspace test command `./scripts/cargo-shared test --workspace --all-targets --locked` exited 0; explicitly environment-gated native/provider rows remain skips, not passes. Manual run `35635486040` is terminally failed on qualifying head `cfe7e29e001dc01f2fa430a54bc8981b44db0b05`: all four configured provider rows failed the hard 1,000 target, and the aggregate verifier failed closed. This run is diagnostic, not acceptance. Current `origin/main` before this publication is `b237a6f1`; no current-tip successful W26 packet is promoted and no Live Cloudflare R2 or Live AWS S3 result is recorded. Focused scans `5fc5a943-07bb-4979-9f37-efd87a7f505e`, `60269206-bb22-4b78-aaf7-f05d16ffcca0`, `1d97028f-e153-4b49-9fac-c3a8c1fc1117`, `c67ae8e0-99af-4ade-8284-a612d599b5e4`, `04c7ba9d-ad9f-40aa-a5b2-d28b9a46a564`, `33c09a35-77f5-417c-862c-e5848185f50e` and `e4ce1aab-c6cd-44e4-b20d-3130ca357412` found zero reportable findings with hosted/provider/customer coverage explicitly deferred; production-config scan `d74e3e86-2e0a-45cf-9819-e31f428eb5d4`, negative-path scan `7addeeb5-4601-4951-aca9-becffb9bd4b9`, retention scan `18010cad-ed69-4da3-b0a9-57163091e878` and contract fixtures also pass locally |
| Latest hosted workflow | Manual GitHub Actions run `35635486040` is terminally failed. Its base `ozone` job `106451808629` passed; `ozone-compositions` `106451808739`, `ozone-tidb` `106451809745`, `ozone-foundationdb` `106451808796` and aggregate `w26-ozone-evidence` `106458415293` failed. The aggregate log recorded `W26_OZONE_EVIDENCE_PACKET_FAIL` because the composition log lacked `OZONE_IOPS_PASS`. The historical green packet remains run `35585066458`; no failed-run artifact is promoted. |
| Current-head CI attempt | The revision-bound run `35635486040` is terminal, not active: SQLite/R2 measured 61.97 IOPS, PGlite/R2 63.56, TiDB/R2 14.14 and FoundationDB/R2 23.07 against the hard target of 1,000, while each row completed all 400 write/read/delete lifecycles with 1,200/1,200 operations, zero timeouts and zero cleanup failures. The trace shows `ChunkedFs` holds its volume-wide operation gate across remote block I/O and full namespace publication, so a correctness-preserving concurrency/performance redesign must be evaluated before any re-run. A new current-tip run is required after W26-owned remediation or an explicit Ozone capacity/topology qualification is supplied. |
...
| Release/acceptance decision | W26 implementation and local qualification controls remain accepted within their documented scope; the latest revision-bound hosted packet is **FAILED / NO-GO** because all four Ozone-backed metadata-provider IOPS rows missed the hard 1,000 target and the aggregate verifier rejected the packet. Latest completed standard security scan `5ad61e60-20e3-4223-885a-d4b516d49bb1`, focused production-config diff scan `d74e3e86-2e0a-45cf-9819-e31f428eb5d4`, negative-path scan `7addeeb5-4601-4951-aca9-becffb9bd4b9`, strict IOPS diff scans `1d97028f-e153-4b49-9fac-c3a8c1fc1117` and `04c7ba9d-ad9f-40aa-a5b2-d28b9a46a564`, evidence-packet diff scans `c67ae8e0-99af-4ade-8284-a612d599b5e4` and `e4ce1aab-c6cd-44e4-b20d-3130ca357412`, and rollout-contract diff scan `33c09a35-77f5-417c-862c-e5848185f50e` report zero local reportable findings, while hosted/provider/customer follow-up remains deferred; production rollout remains **NO-GO** and no broader native release claim is made |
...
| W26.3a — SQLite and disk-backed PGlite composition over real Ozone | Functional composition complete; hard IOPS qualification failed | 100% functional; 85% production qualification | The terminal `ozone-compositions` job `106451808739` on run `35635486040` completed all SQLite/R2 and PGlite/R2 lifecycle operations with zero timeout/cleanup failures, but measured 61.97 and 63.56 IOPS against the hard target of 1,000. Its retained artifact `w26-ozone-compositions-evidence` (ID `10657030963`, digest `06b89ae0af448fea5659a0c998ee83f94409d5c6118f77ea4aeed91a2611d9c2`) is diagnostic only because the job failed and emitted no pass marker. | Determine and test a concurrency/publication design that removes the current volume-wide serialization without weakening fencing, CAS, immutable-block ordering or POSIX semantics; if the implementation is intentionally retained, obtain a production-like Ozone capacity qualification before rerunning. | ~2–5 d implementation/design; 0.5–1.5 d hosted review | Current `ChunkedFs` gate is W26-owned implementation behavior; Ozone fixture capacity/topology and customer target capacity are external gates. |
...
| W26.3c — independent durable three-node FoundationDB composition over Ozone | Durable provider lifecycle and restart markers passed; hard IOPS qualification failed | 90% base; 80% extension | The arm64 durable FoundationDB proof and provider-backed bounded-listing contract remain green. In terminal hosted job `106451808796` on run `35635486040`, FoundationDB Rust and N-API bounded seed/reopen markers passed and all 1,200 lifecycle operations succeeded, but FoundationDB/R2 measured 23.07 IOPS against 1,000. Artifact ID `10656887088`, digest `33ba0dea3fb6731b9a330dfc60e515b0234db8f9aa564d4ee15f6f13e810ce92`, is retained for diagnosis only. Local FoundationDB binary linking remains blocked by missing `libfdb_c`. | Resolve the shared remote-operation serialization/performance gate and rerun the dedicated FoundationDB Ozone lane; preserve the durable restart, fencing, bounded-listing and cleanup assertions. | ~2–5 d shared concurrency work; 0.75–1.5 h hosted review | FoundationDB client image/runtime, Ozone capacity/topology and customer secure durability remain external; the current throughput ceiling also has a W26-owned `ChunkedFs` path. |
| W26.3d — durable multi-node TiDB composition over Ozone | Durable TiDB lifecycle and N-API bounded markers passed; hard IOPS qualification failed | 100% base; 80% extension | The prior run `35585066458` remains the last accepted durable TiDB composition. In terminal hosted job `106451809745` on run `35635486040`, TiDB Rust and N-API bounded seed/reopen markers passed and all 1,200 lifecycle operations succeeded, but TiDB/R2 measured 14.14 IOPS against 1,000; write median/p95/p99 was 6,642.25/7,169.08/7,235.93 ms and read was 5,779.92/6,446.97/6,459.42 ms. Artifact ID `10656158672`, digest `e4b269067f59464e4eb0731d4d87c88b3124f194ffbbff1a6dcfbcaf6e5b894c`, is diagnostic only. | Resolve the shared remote-operation serialization/performance gate and rerun the durable TiDB Ozone lane; preserve the restart, ambiguous-commit, fencing, bounded-listing and cleanup assertions. | ~2–5 d shared concurrency work; 0.75–1.5 h hosted review | GitHub-hosted TiDB/PD/TiKV, N-API runtime, Ozone capacity/topology and customer secure durability remain external; the current throughput ceiling also has a W26-owned `ChunkedFs` path. |
...
| W26.4b — CI wiring, pinned images, cleanup, and documentation | Implementation complete; terminal one-revision packet exercised and failed closed on hard IOPS | 100% implementation; 55% hosted packet qualification | CI installs NAPI/PGlite with locked Rust dependencies, runs the Ozone composition matrix, Node/CLI coverage, the shipped HTTP server/client reopen path, and durable Ozone/TiDB/FoundationDB jobs. Run `35635486040` retained all four producer artifacts and the aggregate job downloaded them, then failed closed because the provider jobs emitted no `OZONE_IOPS_PASS` markers. Base Ozone, policy, bounded-listing, N-API and cleanup paths that ran before the benchmark are recorded separately; failed artifacts are diagnostic only. | Implement or formally qualify the concurrency/performance path, then rerun one current-tip packet and require all provider pass markers, exact artifacts, policy markers, end-to-end markers and cleanup before promotion. | ~2–5 d performance/design; 0.75–1.5 h hosted review per retained run | Workflow concurrency, hosted provider startup, Ozone capacity/topology, artifact service and customer TLS/IAM remain external; no failed/queued/skipped artifact is acceptance evidence. |
| W26.14 — complete end-to-end Ozone evidence-surface gate | Implementation complete; terminal packet failed the hard provider-performance gate; customer admission open | 100% implementation; 35% production qualification | Expanded `scripts/verify-w26-ozone-evidence-packet.mjs` to require gateway health/ready/restart, SQLite/PGlite composition and bounded listing, Rust CLI, Node provider matrix/CLI, remote HTTP CLI, TiDB Rust/N-API seed/reopen and FoundationDB Rust/N-API seed/reopen markers. Local benchmark/evidence tests, Node/shell syntax, YAML parsing, diff checks and the full locked workspace test command exited 0, with environment-gated native/provider rows explicit skips. Security diff scan `e4ce1aab-c6cd-44e4-b20d-3130ca357412` found zero reportable findings. Manual run `35635486040` on `cfe7e29e001dc01f2fa430a54bc8981b44db0b05` reached terminal producer and aggregate failures: all four provider rows completed their lifecycle operations but missed 1,000 IOPS, and `w26-ozone-evidence` `106458415293` rejected the missing pass marker. | Design, implement and locally/hostedly test a safe concurrency/publication path or obtain a production-like Ozone capacity qualification; then rerun the complete packet on the current tip and retain native/mount and customer secure-runtime evidence separately. | ~2–5 d W26 performance/design; ~0.75–1.5 h hosted review; ~0.75–1.25 h security review | The present serialization is W26-owned; Ozone fixture capacity/topology, hosted provider/N-API execution, artifact authorization, native mount runners, customer TLS/IAM/rotation and measured SLO/RPO/RTO remain external. |
...
| P8 — load, capacity, soak and cost envelope | Hosted/provider CI plus W26.15 remediation | Hard-threshold and one-revision packet gates implemented; terminal packet failed all provider rows | 35% | The benchmark records successful write+read+delete lifecycle IOPS, supports a hard `--min-iops` threshold, strict `--require-configured` provider qualification and redacted JSON. The fixed 4 KiB/400-iteration/concurrency-64 profile is enforced. Terminal run `35635486040` completed all 1,200 lifecycle operations per row with zero timeouts/cleanup failures but measured only 61.97/63.56/14.14/23.07 IOPS; aggregate job `106458415293` failed closed because no provider emitted `OZONE_IOPS_PASS`. | Implement and test a safe concurrency/publication path or obtain production-like Ozone capacity/topology evidence; rerun the full five-job packet, retain p95/p99 latency, errors, CPU/memory and topology, then add soak/capacity variants before treating the target as qualified | 2–5 d W26 performance/design; 1–2 d hosted review; soak effort provisional | `ChunkedFs` volume-wide serialization is W26-owned; stable hosted runners, artifact service, Ozone fixture capacity/topology, provider quotas and customer 99.99% capacity remain external |
...
provider artifacts are diagnostic only, W26.15 is open, and no queued,
in-progress, canceled or failed job is promoted to acceptance.
