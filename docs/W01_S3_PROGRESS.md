...
| Faults, cancellation, concurrency and durability | Open | Reset/close, iterator cancellation, crash/power-loss restart, ordering, and provider failure evidence; the local multipart Complete/Abort terminal race is covered |
