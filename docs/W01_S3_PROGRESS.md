...
| Structural driver and local lifecycle | In progress | Oracle-backed source/bucket construction, mixed structural bucket maps, isolation, close, restart, and local filesystem behavior |
