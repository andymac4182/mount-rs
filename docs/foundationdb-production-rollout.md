...
| Replacement hosted run `35720906902`, Linux job `106723334768`, macOS job `106723334336`, dispatched 2026-09-22 from exact revision `65776be87f954ef65dfdc68d41687666631ddcfb` | **QUEUED — no terminal evidence** — both platform jobs are queued; no artifact, marker, aggregate result or production record is promoted | This run tests the published lockfile correction against the exact source binding. A queued replacement is not a qualification pass and does not change the **NO-GO** decision. |
