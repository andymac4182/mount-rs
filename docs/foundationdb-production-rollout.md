...
throughput_ops_per_sec=91.24` and passed the service-restart path. These are
measured qualification results, not production-shaped load, capacity,
retry/error-budget or scaling evidence.
