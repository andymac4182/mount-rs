...
throughput_ops_per_sec=88.62` on the bounded composition workload. This
retains measured qualification evidence, but it is not production-shaped load,
capacity, retry/error-budget or scaling evidence.
