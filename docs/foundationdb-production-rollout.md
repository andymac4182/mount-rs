...
| [Hosted run `35709640688`](https://github.com/andymacclenaghan/mount-rs/actions/runs/35709640688), Linux job `106686845348`, macOS job `106686845149`, aggregate job `106690432291`, exact revision `8b4cbc3860bcb5c0fdfbb1a63cbe3b04f27a5b04`, Ubuntu 24.04/Linux amd64 plus `macos-latest` | **PASS — repaired exact-tip terminal cross-platform qualification after the RustFS lockfile refresh** — all W07 policy, rollout-ledger, production-evidence, workload-artifact, configuration, Linux and macOS preflights passed; Linux durable FoundationDB/RustFS, Node/N-API, Linux CLI/FUSE, service restart, authority republish, fresh-client reopen and RustFS integration passed; the 30-second/120-second heartbeat, reconciled stats, ten-round soak and bounded workload passed; macOS FoundationDB provider/test, CLI `native_lifecycle`, N-API `foundationdb` feature compilation and run-bound provenance passed; the aggregate emitted `W07_PLATFORM_QUALIFICATION_PASS ... provenance=bound`; base `FOUNDATIONDB_LATENCY_PASS workload=composition operations=15 p50_us=3075 p95_us=317846 p99_us=317846 total_ms=384 throughput_ops_per_sec=39.06`; ten isolated soak rounds had p95/p99 from 15,203µs to 576,001µs and throughput from 7.51 to 254.49 ops/s; the bounded workload passed 400 writes, reads and deletes, 1,200 successful lifecycle operations, measured 338.55 IOPS, zero timeouts and zero cleanup failures | Terminal hosted qualification completed with all three jobs green. Linux artifact `foundationdb-production-qualification-35709640688-1` has ID `10686686017` and SHA-256 `18fff6248c364eda9724c8d515677dbe530faf94bad232e3820aef3b78979e38`; macOS artifact `foundationdb-macos-platform-35709640688-1` has ID `10685929115` and SHA-256 `a059c6912485a70e113b2f3a255ffd60f7b9f65eb8017b668db38c7ead036e1b`; aggregate artifact `foundationdb-cross-platform-qualification-35709640688-1` has ID `10686210962` and SHA-256 `f4c7a4b292667e3aa0fb571afaf0495c584d5ec4e93456bcbf484057997a5034`; Linux runner was `GitHub Actions 1000027895` and macOS runner was `GitHub Actions 1000027899`, intentionally distinct platform identities. Independent provenance, workload, summary-replay, platform, production-packet and rollout-ledger validators passed. The retained packet remains `NO-GO` with seven open production gates and zero evidence records; this is terminal cross-platform qualification, not live macOS service/cluster/mount, clean-install, signing/package, production capacity, identity/ACL, backup/restore, failover, observability or owner evidence. |
| [Hosted run `35712676265`](https://github.com/andymacclenaghan/mount-rs/actions/runs/35712676265), Linux job `106696766067`, macOS job `106696766203`, aggregate job `106702286990`, exact revision `ff5cc58188d9783a80de96698a187e1f6416b83e`, Ubuntu 24.04/Linux amd64 plus `macos-latest` | **PASS — current-public-main terminal cross-platform qualification** — all W07 rollout-ledger, production-evidence, workload-artifact and configuration-policy preflights passed; Linux durable FoundationDB/RustFS, Node/N-API, Linux CLI/FUSE, service restart, authority republish, fresh-client reopen, RustFS integration, authority heartbeat/stats, ten-round soak and bounded workload passed; macOS FoundationDB provider/test, CLI `native_lifecycle`, N-API `foundationdb` feature compilation and run-bound provenance passed; the aggregate emitted `W07_PLATFORM_QUALIFICATION_PASS ... provenance=bound`; base `FOUNDATIONDB_LATENCY_PASS workload=composition operations=15 p50_us=2311 p95_us=37919 p99_us=37919 total_ms=91 throughput_ops_per_sec=164.77`; ten isolated soak rounds had p95/p99 from 9,841µs to 17,582µs and throughput from 269.41 to 330.32 ops/s; the bounded workload passed 400 writes, reads and deletes, 1,200 successful lifecycle operations, measured 716.30 IOPS, zero timeouts and zero cleanup failures | Terminal hosted qualification completed with all three jobs green. Linux artifact `foundationdb-production-qualification-35712676265-1` has ID `10688222438` and SHA-256 `711704bd7ce7d21786448beaf6cd1ce32819561d62b10de5a017ea25ee77cba0`; macOS artifact `foundationdb-macos-platform-35712676265-1` has ID `10688396103` and SHA-256 `d80b14aee49333db91e2e744e7bf4c6b908dd4690cf7c6612a9e8559a3b4cfb6`; aggregate artifact `foundationdb-cross-platform-qualification-35712676265-1` has ID `10688622703` and SHA-256 `b3c7a2665bef5c52c865b9758a48da4eef9cde00d6f2a696494861ed170140f4`; Linux runner was `GitHub Actions 1000028125` and macOS runner was `GitHub Actions 1000028123`, intentionally distinct platform identities. Independent provenance, workload, summary-replay, platform, production-packet and rollout-ledger validators passed. The retained packet remains `NO-GO` with seven open production gates and zero evidence records; this is current-public-main qualification only, not live macOS service/cluster/mount, clean-install, signing/package, production capacity, identity/ACL, backup/restore, failover, observability or owner evidence. |
| Follow-up hosted run `35716095938`, Linux job `106707845243`, macOS job `106707844852`, dispatched 2026-09-22 from exact revision `e984c2321317e9d93b8db1ec98dc428662b17d34` | **QUEUED — no terminal evidence** — both platform jobs remain queued; no artifact, marker, aggregate result or production record is promoted | The revision was the public `main` tip at dispatch but later mainline commits advanced beyond it. Evaluate any eventual result against this exact source binding; a queued run is not a qualification pass and does not change the **NO-GO** decision. |
| Terminal audit of hosted run `35716095938`, Linux job `106707845243`, macOS job `106707844852`, aggregate job `106719306381`, exact revision `e984c2321317e9d93b8db1ec98dc428662b17d34` | **FAIL — no hosted qualification pass** — the macOS feature-compile lane passed, but Linux stopped after the provider graph compiled because `tests/foundationdb/Cargo.lock` could not be updated under `--locked`; the aggregate failed closed because the Linux evidence lane was not successful | This is a lockfile/reproducibility failure, not FoundationDB, RustFS, workload, soak or production acceptance. No runtime evidence is promoted. The corrected lockfile is published at `65776be87f954ef65dfdc68d41687666631ddcfb`, and a fresh exact-tip replacement run is required. |
| [Replacement hosted run `35720906902`](https://github.com/andymac4182/mount-rs/actions/runs/35720906902), Linux job `106723334768`, macOS job `106723334336`, aggregate job `106728531688`, exact revision `65776be87f954ef65dfdc68d41687666631ddcfb`, Ubuntu 24.04/Linux amd64 plus `macos-latest` | **PASS — repaired terminal cross-platform qualification** — all W07 rollout-ledger, production-evidence, workload-artifact and configuration-policy preflights passed; Linux durable FoundationDB/RustFS, Node/N-API, Linux CLI/FUSE, service restart, authority republish, fresh-client reopen, RustFS integration, authority heartbeat/stats, ten-round soak and bounded workload passed; macOS FoundationDB provider/test, CLI `native_lifecycle`, N-API `foundationdb` feature compilation and run-bound provenance passed; the aggregate emitted `W07_PLATFORM_QUALIFICATION_PASS ... provenance=bound`; base `FOUNDATIONDB_LATENCY_PASS workload=composition operations=15 p50_us=2376 p95_us=30578 p99_us=30578 total_ms=77 throughput_ops_per_sec=192.50`; ten isolated soak rounds had p95/p99 from 12,074µs to 14,148µs and throughput from 218.02 to 268.12 ops/s; the bounded workload passed 400 writes, reads and deletes, 1,200 successful lifecycle operations, measured 549.87 IOPS, zero timeouts and zero cleanup failures | Terminal hosted qualification completed with all three jobs green. Linux artifact `foundationdb-production-qualification-35720906902-1` has ID `10692331759` and SHA-256 `63576fd2cd59ac9355672ab9469dc1fc0f6268d7ce84993fc3b208c72b62489f`; macOS artifact `foundationdb-macos-platform-35720906902-1` has ID `10691431754` and SHA-256 `5f68497ddfa0118fbb022889985b9d9876496b2fc6384878722c6271e9cae867`; aggregate artifact `foundationdb-cross-platform-qualification-35720906902-1` has ID `10691923414` and SHA-256 `0df99a985e2b6aaebadc589f8bb4b5ebd3412c84d8259221085d023006b7a7c4`; Linux and macOS provenance recorded distinct runners `GitHub Actions 1000028389` and `GitHub Actions 1000028384`. Independent provenance, workload, platform, production-packet and rollout-ledger validators passed. The retained packet remains `NO-GO` with seven open production gates and zero evidence records; this is repaired exact-tip cross-platform qualification only, not live macOS service/cluster/mount, clean-install, signing/package, production capacity, identity/ACL, backup/restore, failover, observability or owner evidence. |
...
| P8 — load, capacity, soak and cost envelope | Harness + exact-tip terminal ten-round cross-platform qualification; production evidence open | The opt-in harness supports bounded repeated real FoundationDB/RustFS composition rounds with unique prefixes and cleanup, and emits p50/p95/p99 operation-latency and throughput markers; latest hosted run `35712676265` at exact revision `ff5cc58188d9783a80de96698a187e1f6416b83e` recorded base `operations=15 p50_us=2311 p95_us=37919 p99_us=37919 total_ms=91 throughput_ops_per_sec=164.77`; ten isolated durable composition rounds passed with p95/p99 from 9,841µs to 17,582µs and throughput from 269.41 to 330.32 ops/s. The same run validated the 400-iteration, 64-concurrency, 4 KiB profile: 400 successful writes, reads and deletes, 1,200 successful lifecycle operations, measured 716.30 lifecycle IOPS, zero timeouts and zero cleanup failures. Linux artifact `foundationdb-production-qualification-35712676265-1` (ID `10688222438`, SHA-256 `711704bd7ce7d21786448beaf6cd1ce32819561d62b10de5a017ea25ee77cba0`) and the aggregate packet were retained; the latency/throughput range is bounded qualification telemetry, not a production capacity or SLO target. Production-shaped duration, retry/error budget, resource growth, safe capacity, cost and scaling triggers are still required |
...
The latest repaired exact-tip qualification is hosted run
...
`106686845348`, macOS job `106686845149` and aggregate job `106690432291` all
green. The Linux run passed the full policy/ledger/evidence/workload preflight,
durable FoundationDB/RustFS composition, service restart, authority republish,
fresh-client reopen, RustFS integration, 30-second/120-second heartbeat,
reconciled stats and ten-round soak; the macOS feature-compile and bound
provenance markers passed; and the aggregate emitted
`W07_PLATFORM_QUALIFICATION_PASS provenance=bound`. Base composition was p50
3,075µs, p95/p99 317,846µs and 39.06 ops/s; ten-round soak p95/p99 was
15,203–576,001µs at 7.51–254.49 ops/s; and the bounded workload recorded 1,200
successful lifecycle operations at 338.55 IOPS with zero timeouts or cleanup
failures. Independent provenance, workload, summary-replay, platform,
production-packet and rollout-ledger validators passed. The latency spread is
qualification telemetry, not a production capacity/SLO claim. The packet
remains qualification-only and **NO-GO**: live macOS service/cluster/mount,
...
The current-public-main qualification refresh is hosted run
...
`106696766067`, macOS job `106696766203` and aggregate job `106702286990` all
green. Linux passed the complete policy/ledger/evidence/workload preflight,
durable FoundationDB/RustFS composition, service restart, authority republish,
fresh-client reopen, RustFS integration, authority heartbeat/stats and
ten-round soak; macOS passed FoundationDB provider/test, CLI
`native_lifecycle`, N-API `foundationdb` feature compilation and bound
provenance; and the aggregate emitted
`W07_PLATFORM_QUALIFICATION_PASS provenance=bound`. Base composition was p50
2,311µs, p95/p99 37,919µs and 164.77 ops/s; ten-round soak p95/p99 was
9,841–17,582µs at 269.41–330.32 ops/s; and the bounded workload recorded
1,200 successful lifecycle operations at 716.30 IOPS with zero timeouts and
zero cleanup failures. The Linux, macOS and aggregate artifact digests are
`711704bd7ce7d21786448beaf6cd1ce32819561d62b10de5a017ea25ee77cba0`,
`d80b14aee49333db91e2e744e7bf4c6b908dd4690cf7c6612a9e8559a3b4cfb6` and
`b3c7a2665bef5c52c865b9758a48da4eef9cde00d6f2a696494861ed170140f4`.
Independent provenance, workload, summary-replay, platform,
production-packet and rollout-ledger validators passed. This is a
current-public-main qualification refresh only; the packet remains
qualification-only and **NO-GO** with seven open production gates and zero
production evidence records.

The repaired replacement qualification is hosted run
[`35720906902`](https://github.com/andymac4182/mount-rs/actions/runs/35720906902)
at exact revision `65776be87f954ef65dfdc68d41687666631ddcfb`, with Linux job
`106723334768`, macOS job `106723334336` and aggregate job `106728531688` all
green. It re-ran the lock-gated durable FoundationDB/RustFS, Node/N-API,
Linux CLI/FUSE, service restart, authority republish, fresh-client reopen,
RustFS integration, heartbeat/stats, ten-round soak and bounded-workload lanes
after the standalone qualification-lock repair; macOS passed the provider,
CLI, N-API feature-compile and run-bound provenance lanes; the aggregate
emitted `W07_PLATFORM_QUALIFICATION_PASS provenance=bound`. Base composition
was p50 2,376µs, p95/p99 30,578µs and 192.50 ops/s; ten-round soak p95/p99
was 12,074–14,148µs at 218.02–268.12 ops/s; and the bounded workload recorded
1,200 successful lifecycle operations at 549.87 IOPS with zero timeouts and
zero cleanup failures. Linux, macOS and aggregate artifact IDs/digests are
`10692331759`/`63576fd2cd59ac9355672ab9469dc1fc0f6268d7ce84993fc3b208c72b62489f`,
`10691431754`/`5f68497ddfa0118fbb022889985b9d9876496b2fc6384878722c6271e9cae867`
and `10691923414`/`0df99a985e2b6aaebadc589f8bb4b5ebd3412c84d8259221085d023006b7a7c4`.
Independent provenance, workload, platform, production-packet and
rollout-ledger validators passed. This is repaired hosted qualification only;
the packet remains qualification-only and **NO-GO** with seven open production
gates and zero production evidence records.
