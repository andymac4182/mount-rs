...
| --- | --- | ---: | --- | --- | ---: | --- |
| FUSE bounded-unmount lifecycle chunk | Published implementation chunk; hosted Linux/native confirmation pending | 100% code/local checks / 0% hosted-kernel confirmation | Published candidate `1bdd6adf` adds the result-publication race fix, stops a stalled session before the graceful helper consumes the full timeout, and treats only a confirmed `EBUSY` helper result as a bounded lazy-detach handoff. Host `mount-rs-fuse` tests 14/14, Linux-target `cargo check --locked -p mount-rs-fuse --tests`, `cargo fmt --all -- --check`, and `git diff --check` passed. | Inspect Ubuntu Rust and native-FUSE logs from the exact-tip run; preserve the change as a separate production evidence item until those jobs pass. | 0.25–0.75h engineering; runner wait external | Hosted Linux kernel/FUSE gate |
| Exact-tip qualification run | Queued; no current-tip acceptance promoted | 0% terminal current-tip matrix | Run [35673738166](https://github.com/andymac4182/mount-rs/actions/runs/35673738166) targets exact SHA `1bdd6adfe6e984a5e7e27ddf0edfb3bbd9d24462`. Node jobs are macOS-latest [106575734937](https://github.com/andymac4182/mount-rs/actions/runs/35673738166/job/106575734937), Linux [106575734945](https://github.com/andymac4182/mount-rs/actions/runs/35673738166/job/106575734945), ARM [106575734968](https://github.com/andymac4182/mount-rs/actions/runs/35673738166/job/106575734968), and macOS-15-intel [106575734997](https://github.com/andymac4182/mount-rs/actions/runs/35673738166/job/106575734997); Ubuntu Rust is [106575735233](https://github.com/andymac4182/mount-rs/actions/runs/35673738166/job/106575735233), and native FUSE is [106575735045](https://github.com/andymac4182/mount-rs/actions/runs/35673738166/job/106575735045). All are queued at this snapshot. No exact recovery-step PASS is claimed. | Wait for all four Node jobs and inspect their exact early-rejection and `Verify PGlite integration and restart recovery` steps; then inspect Ubuntu Rust/native-FUSE, artifact/package, provider, and aggregate results. | 0.25–0.75h engineering; hosted wait external | GitHub-hosted runner scheduling and provider services |
| Production rollout decision | NO-GO | 0% final release approval | The demo and historical W04.2 evidence remain supporting evidence only. Provider/performance scope, deployment-specific persistence/backup/rollback, observability/runbook execution, named ownership, and release approval are still open. | Keep the rollout decision NO-GO until the exact published candidate has terminal evidence and the production matrix is signed by the deployment and release owners. | 3–8h engineering plus owner/provider execution | Provider IOPS, deployment environment, operational owners, release authority |

## Snapshot

| Field | Current value |
| --- | --- |
| Current recovery state | ARM Node [106553420990](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420990) passed the exact `Verify PGlite integration and restart recovery` step and fragmented HTTP early-rejection step; Windows Node [106553420495](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420495) passed its package/consumer checks. Ozone/TiDB [106553420645](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420645) failed the 1,000-IOPS gate at 30.34 IOPS after the functional Ozone contract passed; Ozone/FoundationDB [106553422646](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553422646) failed at 56.72 IOPS after durable chunk/reopen and cleanup passed. Intel macOS [106553420615](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420615) is in progress; macOS-latest [106553420598](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420598), Linux Node [106553420623](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420623), and Ubuntu Rust [106553420609](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420609) remain queued. This is partial evidence only. |
| Snapshot base revision | `13960b12` (current `origin/main` at this ledger update; includes the published WebDAV parity metadata fix `9b2dabd7`, Ozone cleanup fix `23c0ba7e`, and concurrent unrelated mainline work) |
...
| Current-head local evidence revision | `23c0ba7e` includes the published WebDAV parity metadata fix and deduplicated Ozone cleanup; focused WebDAV parity passed 30 repetitions, the Ozone R2 unit suite passed 18/18 and its standalone workspace compiled locked, host-safe FUSE tests passed 14/14, and PGlite/R2/FDB/native-mount rows remained explicit skips where prerequisites were absent |
...
| Latest published repository revision | `13960b12` (current `origin/main`; the WebDAV/Ozone recovery chunks and terminal qualification evidence are ancestors, with unrelated mainline commits preserved) |
...
| Snapshot time | 2026-09-22 09:34 AEST |
| Latest current-tip requalification | Manual run [35666527609](https://github.com/andymac4182/mount-rs/actions/runs/35666527609) was dispatched at head `9b2dabd7bf3f4bf985970c576d71193ac763a49c`, before the subsequently published Ozone cleanup fix `23c0ba7e`. At this snapshot, Windows Node [106553420495](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420495) and ARM Node [106553420990](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420990) were in progress; Linux Node [106553420623](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420623), macOS-latest [106553420598](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420598), macOS-15-intel [106553420615](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420615), Ozone/TiDB [106553420645](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420645), and Ozone/FoundationDB [106553422646](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553422646) remained queued. This run can confirm the WebDAV fix but cannot by itself qualify the current Ozone tip; no step or run acceptance is inferred until every required Node job completes and the exact PGlite/restart step passes. |
...
| Current external blocker | The recovery run [35666527609](https://github.com/andymac4182/mount-rs/actions/runs/35666527609) is still queued/in progress across the required Node matrix, so current-tip hosted confirmation is not terminal. The run also predates the published Ozone cleanup fix. Production remains NO-GO pending current hosted evidence plus deployment-specific persistence/backup/rollback, provider scope/performance, observability/runbook/ownership, and release approval. |
...
| --- | --- | ---: | --- | --- | ---: | --- |
| Current recovery-run hosted evidence | Partial — accepted ARM/Windows sub-results, provider performance failures, macOS/Linux Node gates incomplete | 100% ARM Node exact gate / 100% Windows package gate / 0% required macOS/Linux current-tip gate | Recovery run [35666527609](https://github.com/andymac4182/mount-rs/actions/runs/35666527609) ARM Node [106553420990](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420990) passed the exact PGlite/restart and early-rejection steps; Windows Node [106553420495](https://github.com/andymac4182/mount-rs/actions/runs/35666527609/job/106553420495) passed package/consumer checks. Ozone/TiDB failed at 30.34 IOPS and Ozone/FoundationDB at 56.72 IOPS against 1,000 after functional/cleanup markers passed. Intel macOS is in progress; macOS-latest and Linux Node remain queued. | Inspect the Intel macOS, macOS-latest, Linux Node, and Ubuntu Rust logs on completion; then dispatch a current-main run containing `23c0ba7e` for Ozone requalification. Do not close W04 or production from this partial run. | 0.25–0.75h evidence work; hosted runner/provider wait external | Hosted/provider gate |
| W04 recovery chunks and hosted requalification control | In progress — implementation chunks published; current hosted confirmation pending | 100% local repair / 0% current-tip hosted requalification | WebDAV session parity now pins identical native/oracle mtimes (`9b2dabd7`); Ozone cleanup now deduplicates the repeated block ID (`23c0ba7e`). Local focused checks passed, while stale qualification `35664315098` was canceled after its macOS runner remained queued. Recovery run `35666527609` is active, but it predates the Ozone fix and has not yet produced terminal Node evidence. | Inspect every recovery Node log, require exact early-rejection and PGlite/restart PASS on Linux, ARM, macOS-latest, and macOS-15-intel, then requalify the Ozone fix separately; preserve NO-GO for partial or queued evidence. | 0.5–1h engineering; hosted runner/provider wait external | Release engineering / hosted gate |
...
| Hosted Linux Node acceptance | Complete — accepted W04.2 evidence; fresh current-tip confirmation pending | 100% accepted historical gate / 0% fresh recovery run | Run [35635114595](https://github.com/andymac4182/mount-rs/actions/runs/35635114595), job [106450522757](https://github.com/andymac4182/mount-rs/actions/runs/35635114595/job/106450522757), completed successfully; the exact PGlite/restart and fragmented early-rejection steps passed, with PGlite-inclusive trace and explicit provider skips. | Inspect the Linux Node job in recovery run `35666527609`; do not replace the accepted W04.2 record until the current candidate is terminal. | 0.1h engineering; hosted runner wait external | Hosted gate |
| Hosted macOS-latest Node acceptance | Complete — accepted W04.2 evidence; fresh current-tip confirmation pending | 100% accepted historical gate / 0% fresh recovery run | Run [35635114595](https://github.com/andymac4182/mount-rs/actions/runs/35635114595), job [106450522868](https://github.com/andymac4182/mount-rs/actions/runs/35635114595/job/106450522868), completed successfully at `2026-09-21T18:07:05Z`; the exact PGlite/restart and fragmented early-rejection steps passed, the log recorded `providersFailed: 0`, PGlite/chunked-PGlite trace PASS, `PGLITE_BACKUP_RESTORE_ROLLBACK_PASS`, and storage artifact `10656542212`. | Inspect the macOS-latest job in recovery run `35666527609`; queued/in-progress evidence is not acceptance. | 0.1h engineering; hosted runner wait external | Hosted/native gate |
| Hosted macOS-15-intel Node acceptance | Complete — accepted W04.2 evidence; fresh current-tip confirmation pending | 100% accepted historical gate / 0% fresh recovery run | Run [35635114595](https://github.com/andymac4182/mount-rs/actions/runs/35635114595), job [106450522845](https://github.com/andymac4182/mount-rs/actions/35635114595/job/106450522845), completed successfully at `2026-09-21T18:13:03Z`; the exact PGlite/restart step passed after the long Intel trace at `18:12:45Z`, early rejection passed, the log recorded `providersFailed: 0`, PGlite/chunked-PGlite trace PASS, `PGLITE_BACKUP_RESTORE_ROLLBACK_PASS`, and storage artifact `10656562978`; the historical socket EPIPE did not recur. | Inspect the macOS-15-intel job in recovery run `35666527609`; require the exact early-rejection and PGlite/restart steps to pass before promoting current-tip evidence. | 0.1h engineering; hosted runner wait external | Hosted/native gate |
