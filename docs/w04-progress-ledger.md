...
| Replacement exact-tip qualification run | Terminal cancelled; diagnosis complete; no acceptance promoted | 0% terminal current-tip matrix | Run [35675591961](https://github.com/andymac4182/mount-rs/actions/runs/35675591961) targeted published head `0c31c167024874f68dac1b04b4fd0aceb343c347` and ended **cancelled** after native FUSE [106581350258](https://github.com/andymac4182/mount-rs/actions/runs/35675591961/job/106581350258) exceeded its configured timeout. The four Unix Node jobs and Windows Node [106581349897](https://github.com/andymac4182/mount-rs/actions/runs/35675591961/job/106581349897) failed before W04 recovery at `test/types.test.ts(655,9)` with `Record<string, number>` versus `Map<string, number>`; no exact recovery-step PASS is claimable. | Dispatch a fresh qualification from published `819c663e`; inspect every Node log, require the exact early-rejection and `Verify PGlite integration and restart recovery` steps on all four platforms, then inspect Ubuntu Rust/native-FUSE, aggregate/package, provider, and artifact evidence. | 0.5–1h engineering; hosted runner/provider wait external | GitHub-hosted runner scheduling and current package/native/provider gates |
| Current exact-tip qualification run | Queued; no acceptance promoted | 0% terminal current-tip matrix | Run [35678123095](https://github.com/andymac4182/mount-rs/actions/runs/35678123095) targets published head `0b6e8c4f01ebdd9254c7d6c61595628e0ce4a824`. Node jobs are Ubuntu [106588864184](https://github.com/andymac4182/mount-rs/actions/runs/35678123095/job/106588864184), ARM [106588864228](https://github.com/andymac4182/mount-rs/actions/runs/35678123095/job/106588864228), macOS-15-intel [106588864181](https://github.com/andymac4182/mount-rs/actions/runs/35678123095/job/106588864181), macOS-latest [106588864034](https://github.com/andymac4182/mount-rs/actions/runs/35678123095/job/106588864034), and Windows [106588864128](https://github.com/andymac4182/mount-rs/actions/runs/35678123095/job/106588864128). Ubuntu Rust is [106588864166](https://github.com/andymac4182/mount-rs/actions/runs/35678123095/job/106588864166), native FUSE is [106588864049](https://github.com/andymac4182/mount-rs/actions/runs/35678123095/job/106588864049), native WebDAV jobs are [106588864150](https://github.com/andymac4182/mount-rs/actions/runs/35678123095/job/106588864150) and [106588864059](https://github.com/andymac4182/mount-rs/actions/runs/35678123095/job/106588864059), and provider/package dependencies remain queued. | Stay quiet while queued/unchanged; when jobs start or complete, inspect their logs. Require all four Node exact `Verify PGlite integration and restart recovery` steps, then inspect native, package/artifact, provider, and observability evidence. | 0.5–1h engineering; hosted runner/provider wait external | GitHub-hosted scheduling, native kernel, package artifacts, provider performance, and production-owner gates |
...
| Field | Current value |
| --- | --- |
| Live qualification state | Current run [35678123095](https://github.com/andymac4182/mount-rs/actions/runs/35678123095) targets published `0b6e8c4f01ebdd9254c7d6c61595628e0ce4a824` and is **queued**. The prior run [35675591961](https://github.com/andymac4182/mount-rs/actions/runs/35675591961) is terminally cancelled and excluded. No queued or current-tip hosted acceptance is claimed. |
...
| Snapshot base revision | `819c663e` (published WebDAV provider-network cleanup retry on top of current `origin/main`, including retained P9 clean-build normalization and published FUSE fixes) |
...
| Current-head local evidence revision | `819c663e` includes the published WebDAV parity metadata fix, Ozone cleanup deduplication, clean-build P9 stats declaration normalization, FUSE fixes, and provider-network cleanup retry; host-safe FUSE tests passed 14/14, five fresh concurrency-64 WebDAV provider runs passed, the PGlite policy and lifecycle rehearsals passed, N-API artifact aggregation passed, and generated typecheck/diff checks were green. |
...
| Latest published repository revision | `819c663e` (`test(napi): retry provider network cleanup`), pushed to `origin/main`; this ledger update is the next documentation chunk and will preserve unrelated mainline commits. |
...
| Snapshot time | 2026-09-22 12:05 AEST |
