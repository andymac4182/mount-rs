...
| --- | --- | ---: | --- | --- | ---: | --- |
| FUSE bounded-unmount lifecycle chunk | Published implementation chunk; hosted Linux/native confirmation pending | 100% code/local checks / 0% hosted-kernel confirmation | Published candidate `d3c9bb9d` adds the result-publication race fix and stops a stalled session before the graceful helper consumes the full timeout. `cargo fmt --all -- --check`, `git diff --check`, host `mount-rs-fuse` tests 14/14, and Linux-target `cargo check --locked -p mount-rs-fuse --tests` passed. | Inspect Ubuntu Rust and native-FUSE logs from the exact-tip run; preserve the change as a separate production evidence item until those jobs pass. | 0.25–0.75h engineering; runner wait external | Hosted Linux kernel/FUSE gate |
| Exact-tip qualification run | In progress; no current-tip acceptance promoted | 0% terminal current-tip matrix | Run [35673297621](https://github.com/andymac4182/mount-rs/actions/runs/35673297621) is executing exact SHA `d3c9bb9dd6e1ac78da8e98f5f333c9edf571563c`. ARM Node [106574359235](https://github.com/andymac4182/mount-rs/actions/runs/35673297621/job/106574359235) and macOS-15-intel Node [106574359291](https://github.com/andymac4182/mount-rs/actions/runs/35673297621/job/106574359291) are in progress; macOS-latest Node [106574359308](https://github.com/andymac4182/mount-rs/actions/runs/35673297621/job/106574359308), Linux Node [106574359333](https://github.com/andymac4182/mount-rs/actions/runs/35673297621/job/106574359333), Ubuntu Rust [106574359238](https://github.com/andymac4182/mount-rs/actions/runs/35673297621/job/106574359238), and native FUSE [106574358995](https://github.com/andymac4182/mount-rs/actions/runs/35673297621/job/106574358995) are queued at this snapshot. No exact recovery-step PASS is claimed yet. | Wait for all four Node jobs and inspect their exact early-rejection and `Verify PGlite integration and restart recovery` steps; then inspect Ubuntu Rust/native-FUSE, artifact/package, provider, and aggregate results. | 0.25–0.75h engineering; hosted wait external | GitHub-hosted runner scheduling and provider services |
