...
| Field | Current value |
| --- | --- |
| Snapshot base revision | `c54b6bde` (current `origin/main` at this ledger update; includes the published WebDAV parity metadata fix `9b2dabd7`, Ozone cleanup fix `23c0ba7e`, and concurrent unrelated mainline work) |
...
| Latest published repository revision | `c54b6bde` (current `origin/main`; the WebDAV/Ozone recovery chunks and terminal qualification evidence are ancestors, with unrelated mainline commits preserved) |
...
| Snapshot time | 2026-09-22 09:23 AEST |
