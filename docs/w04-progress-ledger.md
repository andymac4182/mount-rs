...
| Credential-free PGlite-only launch-config policy | Complete; exact hosted policy step passed in job `106423435077`; 0.25h evidence retention remaining | Hosted step is bounded evidence only because enclosing CI run `35626892113` was cancelled; no provider connection or secret was used |
