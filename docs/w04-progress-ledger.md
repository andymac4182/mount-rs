...
| Latest published repository revision | `73c4b47f` (current `origin/main`; W04 peer-fault hardening `093565d9` is an ancestor and was rebased with unrelated mainline commits preserved) |
...
| Snapshot time | 2026-09-22 06:42 AEST |
...
| Current external blocker | The terminal fixed-tip run [35651055621](https://github.com/andymac4182/mount-rs/actions/runs/35651055621) exposed a newer W01/S3 parity regression before the W04 recovery step: all four Unix Node jobs returned Rust ETag `22801ba05185c8cc8aad97c7b9d1ed6c-1` where the TypeScript oracle returned `483eafaaf0c86330cf62199b2d5cb4d5-1` for `s3/multipart-complete-signed-trailer`. Ubuntu Rust [106503290545](https://github.com/andymac4182/mount-rs/actions/runs/35651055621/job/106503290545) failed the forced-unmount deadline test, native FUSE [106503290699](https://github.com/andymac4182/mount-rs/actions/runs/35651055621/job/106503290699) had two native-unmount timeouts, and Ozone/TiDB/RustFS provider jobs failed their configured gates; W26 evidence [106508142092](https://github.com/andymac4182/mount-rs/actions/runs/35651055621/job/106508142092) failed closed on the missing `OZONE_IOPS_PASS` marker. The earlier provider evidence remains: run `35635114595` recorded 47.48/57.85, 15.37, and 32.86 IOPS against the hard 1,000 target, while the prior four Ubuntu FUSE failures were resolved by `d2db74dd`. Production remains NO-GO pending separately owned W01/provider/native remediation or scope decisions, deployment-specific persistence/backup/rollback, observability/runbook/ownership, and release approval. |
