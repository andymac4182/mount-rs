...
| Field | Current value |
| --- | --- |
| Live qualification state | No fresh qualification is running at this snapshot. Replacement run [35675591961](https://github.com/andymac4182/mount-rs/actions/runs/35675591961) targeted `0c31c167`, ended **cancelled**, and is excluded after its Node jobs failed the generated P9 declaration check and native FUSE exceeded its timeout. The next run will target published `819c663e`; no current-tip hosted acceptance is claimed. |
...
| Snapshot time | 2026-09-22 12:01 AEST |
