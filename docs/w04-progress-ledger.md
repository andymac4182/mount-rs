...
| Exact-tip qualification run | Canceled as obsolete pre-fix; replacement required | 0% terminal current-tip matrix | Run [35674630831](https://github.com/andymac4182/mount-rs/actions/runs/35674630831) targeted head `ba20d29d7e8ad00b3c4b5270dc21cf6ab913e4c2`, before `d0a67b22`. ARM Node [106578408127](https://github.com/andymac4182/mount-rs/actions/runs/35674630831/job/106578408127) failed at generated typecheck with `TS2740` because a clean build regenerated `Record<string, number>` while the test required `Map<string, number>`; the run was canceled after this pre-fix diagnosis. No exact recovery-step PASS is claimed. | Dispatch a replacement run from the next published `origin/main` tip; require all four Node exact early-rejection and `Verify PGlite integration and restart recovery` steps, Ubuntu Rust, native FUSE, aggregate/package, and provider evidence before promoting any current-tip result. | 0.5–1h engineering; hosted runner/provider wait external | GitHub-hosted runner scheduling and current package/native/provider gates |
...
| Field | Current value |
| --- | --- |
| Live qualification state | Replacement pending after obsolete pre-fix run [35674630831](https://github.com/andymac4182/mount-rs/actions/runs/35674630831) was canceled. Its ARM Node job [106578408127](https://github.com/andymac4182/mount-rs/actions/runs/35674630831/job/106578408127) failed only at the generated `P9SessionStats.messages` type check on pre-`d0a67b22` head `ba20d29d`; the clean-build normalization is now locally verified on the synchronized tree. No current-tip hosted acceptance is claimed. |
...
| Snapshot time | 2026-09-22 11:12 AEST |
