...
| Snapshot time | 2026-09-22 04:59 AEST |
...
positive/invalid-TTL policy fixtures passed on current-tip run `35641832862`,
and local CLI/SDK qualification passes on `113a1fbc`. The local
