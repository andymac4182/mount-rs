...
| N-API clean-build declaration normalization | Published implementation; current-tip hosted confirmation pending | 100% local implementation/build/typecheck / 0% current-tip hosted confirmation | Current tree includes `d0a67b22`, which preserves `P9SessionStats.messages` as `Map<string, number>` after a clean `pnpm --dir integrations/mount-rs-napi build`; the release build completed, generated declarations retained `Map<string, number>`, and the focused typecheck passed. | Require the replacement hosted Node matrix to complete the generated-type and exact W04 recovery steps on every advertised platform. | 0.25–0.5h engineering; hosted wait external | Hosted package/Node matrix |
...
| Replacement exact-tip qualification run | Queued/in progress; no current-tip acceptance promoted | 0% terminal current-tip matrix | Run [35675591961](https://github.com/andymac4182/mount-rs/actions/runs/35675591961) targets published head `0c31c167024874f68dac1b04b4fd0aceb343c347`. Node jobs: Ubuntu [106581350060](https://github.com/andymac4182/mount-rs/actions/runs/35675591961/job/106581350060), ARM [106581349931](https://github.com/andymac4182/mount-rs/actions/runs/35675591961/job/106581349931), macOS-15-intel [106581349894](https://github.com/andymac4182/mount-rs/actions/runs/35675591961/job/106581349894), and macOS-latest [106581349948](https://github.com/andymac4182/mount-rs/actions/runs/35675591961/job/106581349948); Ubuntu Rust is [106581349888](https://github.com/andymac4182/mount-rs/actions/runs/35675591961/job/106581349888), native FUSE is [106581350258](https://github.com/andymac4182/mount-rs/actions/runs/35675591961/job/106581350258), and Windows Node is [106581349897](https://github.com/andymac4182/mount-rs/actions/runs/35675591961/job/106581349897). ARM Node and provider jobs had started at this snapshot; no exact recovery-step PASS is claimed. | Inspect every Node log on completion, require the exact early-rejection and `Verify PGlite integration and restart recovery` steps on all four platforms, then inspect Ubuntu Rust/native-FUSE, aggregate/package, provider, and artifact evidence. | 0.5–1h engineering; hosted runner/provider wait external | GitHub-hosted runner scheduling and current package/native/provider gates |
...
| Field | Current value |
| --- | --- |
| Live qualification state | Replacement run [35675591961](https://github.com/andymac4182/mount-rs/actions/runs/35675591961) targets published `0c31c167`; ARM Node [106581349931](https://github.com/andymac4182/mount-rs/actions/runs/35675591961/job/106581349931) and provider jobs had started while the macOS Node jobs remained queued/in progress at this snapshot. The pre-fix run [35674630831](https://github.com/andymac4182/mount-rs/actions/runs/35674630831) is canceled and excluded. No current-tip hosted acceptance is claimed. |
...
| Snapshot base revision | `d0a67b22` (synchronized code base before this ledger publication; includes the clean-build P9 stats declaration normalization, published FUSE fixes, and concurrent unrelated mainline work) |
...
| Current-head local evidence revision | `d0a67b22` includes the published WebDAV parity metadata fix, Ozone cleanup deduplication, clean-build P9 stats declaration normalization, and FUSE fixes; host-safe FUSE tests passed 14/14, the PGlite policy and lifecycle rehearsals passed, N-API artifact aggregation passed, and generated typecheck/diff checks were green. |
...
| Latest published repository revision | `d0a67b22` code base before this ledger publication; the ledger commit will be recorded in Git history after the checks below, with unrelated mainline commits preserved |
...
| Snapshot time | 2026-09-22 11:24 AEST |
