...
| Field | Current value |
| --- | --- |
| Snapshot base revision | `cfd0ef5` (current `origin/main` immediately before this evidence publication; it includes the published W04 policy/recovery chunks, dedicated policy workflow, and prior evidence ledger plus concurrent mainline commits; qualification run `35620669973` used the earlier isolated source `f54590c`) |
| Ledger publication | This current ledger revision records the terminal current-tip dedicated W04 PGlite policy workflow evidence; it is published on `origin/main`, with the exact commit recorded in Git history |
...
| Latest published repository revision | `cfd0ef5` (current `origin/main` tip before this evidence publication; W04 chunks and unrelated concurrent commits are preserved) |
...
| Snapshot time | 2026-09-22 02:55 AEST |
