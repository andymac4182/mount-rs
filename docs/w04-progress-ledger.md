...
| Field | Current value |
| --- | --- |
| Snapshot base revision | `e9a6b25` (current `origin/main` immediately before this evidence publication; it includes the published W04 policy/recovery chunks, dedicated policy workflow, prior evidence ledger, and concurrent mainline commits; qualification run `35620669973` used the earlier isolated source `f54590c`) |
...
| Latest published repository revision | `e9a6b25` (current `origin/main` tip before this evidence publication; W04 chunks and unrelated concurrent commits are preserved) |
...
| Snapshot time | 2026-09-22 03:03 AEST |
