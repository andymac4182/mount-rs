...
| Field | Current value |
| --- | --- |
| Snapshot base revision | `0bb628b` (current `origin/main` immediately before this evidence publication; it includes the published W04 policy/recovery chunks, dedicated policy workflow, manual-dispatch qualification controls, prior evidence ledger, and concurrent mainline commits; qualification run `35630660185` used the earlier isolated source `42f83bd`) |
| Ledger publication | This current ledger revision records the terminal manual-dispatch full-CI evidence and current production blockers; it is published on `origin/main`, with the exact commit recorded in Git history |
...
| Latest published repository revision | `0bb628b` (current `origin/main` tip before this evidence publication; W04 chunks and unrelated concurrent commits are preserved) |
| Latest full qualification evidence | Manual-dispatch run [35630660185](https://github.com/andymac4182/mount-rs/actions/runs/35630660185) at head `42f83bd538b02e7c858137bf16ad38bbdee7480d`, terminal overall **failure**. All four Node jobs passed the exact PGlite/restart step: ARM [106435785258](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785258), Linux [106435785499](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785499), macOS-latest [106435785811](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785811), and macOS-15-intel [106435785693](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785693). The macOS logs recorded PGlite/chunked-PGlite trace PASS, `providersFailed: 0`, `PGLITE_BACKUP_RESTORE_ROLLBACK_PASS`, and smoke artifacts `10655221512` and `10654697002`; Windows Node [106435785382](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785382) uploaded `native-win32-x64-msvc.zip` artifact `10654064663` with digest `e59a4cde188be1d0254b556d5bda29b3d430e5c9a219d19ed6874114d5ad6fb4`; aggregate-native [106442823972](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106442823972) passed package aggregation and clean-consumer smoke. Ozone compositions [106435785214](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785214) measured 35.91 and 59.25 IOPS, Ozone/TiDB [106435785095](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785095) measured 14.69, and Ozone/FoundationDB [106435785295](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785295) measured 7.50, all below the hard 1,000 target. Ubuntu Rust [106435785333](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785333) failed four FUSE lifecycle tests; this remains an open current-tip CI/code gate. |
| Snapshot time | 2026-09-22 03:36 AEST |
...
| Hosted/native/provider acceptance | **W04.2 and the current Node/package candidate gates are complete; production provider scope and a current Rust gate remain open**: manual run [35630660185](https://github.com/andymac4182/mount-rs/actions/runs/35630660185) passed all four Node exact PGlite/restart steps, Windows package distribution, five-package aggregation, and clean-consumer smoke. FoundationDB/RustFS [106435785015](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785015) passed durable chunk/reopen, configured FUSE, N-API, service restart, and cleanup markers. Ozone functional composition/restart/fault checks completed, but the Ozone IOPS rows failed the 1,000 target; Ubuntu Rust [106435785333](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785333) failed four FUSE lifecycle tests. The run is therefore not a release pass. |
...
| Current external blocker | Manual run [35630660185](https://github.com/andymac4182/mount-rs/actions/runs/35630660185) recorded Ozone lifecycle IOPS of 35.91/59.25 in `ozone-compositions`, 14.69 in `ozone-tidb`, and 7.50 in `ozone-foundationdb`, each below the hard 1,000 target despite successful cleanup. It also exposed four Ubuntu FUSE lifecycle test failures in job [106435785333](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785333), which require diagnosis before a clean full-CI claim. The manual-dispatch concurrency control prevented mainline cancellation and established a usable terminal evidence packet; production remains NO-GO pending the Rust gate, provider launch-scope decision or passing performance evidence, deployment-specific persistence/backup/rollback, observability/runbook/ownership, and release approval. |
...
| --- | --- | ---: | --- | --- | ---: | --- |
| W04 implementation packet and deterministic local qualification | Complete — current Node/package candidate green; provider/operations follow-up open | 100% implementation / 100% current Node/package qualification | The current packet includes the socket server, cleanup/fencing fixes, version metadata, mount-free VFS, native hosting tests, the published fixture-shutdown EPIPE fixes `bdfcb11` and `41d5514`, and the privileged-FUSE rootmode correction `a55bd64`; the oracle-enabled local gate at `6d59d20` exited 0 with upstream `1,200 passed / 82 skipped` and trace `40/40`. Manual run `35630660185` then passed all four Node exact PGlite/restart steps, Windows package distribution, aggregate-native, and clean-consumer smoke. | Diagnose and fix the four Ubuntu FUSE lifecycle failures, then decide launch provider scope and complete deployment-specific persistence/rollback and operations evidence; the terminal provider IOPS failures remain external/performance gates. | 0.5–1.5h engineering; hosted/provider wait external | Engineering plus hosted gate |
| Hosted Linux Node acceptance | Complete — current candidate confirmation | 100% | Manual run [35630660185](https://github.com/andymac4182/mount-rs/actions/runs/35630660185), job [106435785499](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785499), completed successfully; exact PGlite/restart and fragmented early-rejection steps passed, with PGlite-inclusive trace and explicit provider skips. | None for the hosted Linux W04.2 gate; the separate Ubuntu Rust FUSE gate remains open. | 0h | Hosted gate |
| Hosted macOS-latest Node acceptance | Complete — current candidate confirmation | 100% | Manual run [35630660185](https://github.com/andymac4182/mount-rs/actions/runs/35630660185), job [106435785811](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785811), completed successfully at `2026-09-21T17:32:56Z`; exact PGlite/restart and fragmented early-rejection steps passed, the log recorded `providersFailed: 0`, PGlite/chunked-PGlite trace PASS, `PGLITE_BACKUP_RESTORE_ROLLBACK_PASS`, and artifact `10655221512`. | None for the hosted macOS-latest W04.2 gate. | 0h | Hosted/native gate |
| Hosted macOS-15-intel Node acceptance | Complete — current candidate confirmation | 100% | Manual run [35630660185](https://github.com/andymac4182/mount-rs/actions/runs/35630660185), job [106435785693](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785693), completed successfully at `2026-09-21T17:33:46Z`; the exact PGlite/restart step passed after the long Intel trace, early rejection passed, the log recorded `providersFailed: 0`, `PGLITE_BACKUP_RESTORE_ROLLBACK_PASS`, and artifact `10654697002`; the historical socket EPIPE did not recur. | None for the hosted macOS-15-intel W04.2 gate. | 0h | Hosted/native gate |
| Native package/artifact and consumer validation | Complete — current candidate | 100% | Manual Windows Node job [106435785382](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785382) uploaded `native-win32-x64-msvc.zip` as artifact `10654064663`, SHA-256 `e59a4cde188be1d0254b556d5bda29b3d430e5c9a219d19ed6874114d5ad6fb4`. Aggregate job [106442823972](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106442823972) passed five-package artifact aggregation and `mount-rs clean consumer install/smoke: PASS`. | Retain the exact artifact/hash in the release record; production release remains NO-GO until persistence/rollback, provider scope, operations, ownership, and the Ubuntu Rust gate close. | 0.25h evidence publication; 0h package implementation | Hosted/package gate |
| Production-like persistence, restart, and version recovery | Hosted candidate qualification complete; current-tip dedicated hosted config policy and local backup/rollback rehearsal green; deployment evidence pending | 90% hosted qualification / 60% config-and-local rehearsal / 0% production drill | Manual run [35630660185](https://github.com/andymac4182/mount-rs/actions/runs/35630660185) passed all four exact PGlite/restart steps and PGlite-inclusive five-seed/eight-backend traces; its macOS logs also emitted `PGLITE_BACKUP_RESTORE_ROLLBACK_PASS`. FoundationDB/RustFS [106435785015](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785015) passed durable chunk/reopen, service restart, configured FUSE, and cleanup markers. The current-tip dedicated non-cancelling policy run [35629439034](https://github.com/andymac4182/mount-rs/actions/runs/35629439034), job [106431854955](https://github.com/andymac4182/mount-rs/actions/runs/35629439034/job/106431854955), completed successfully on `e9a6b25` and emitted `W04_PGLITE_PRODUCTION_CONFIG_POLICY_PASS` plus the expected non-durable and inline-secret rejection markers. These checks demonstrate configuration shape and local/hosted control flow, not the actual production deployment. | Bind the actual PGlite server data directory/configuration and version policy, and execute an approved encrypted backup/restore and rollback drill with measured RPO/RTO and owner approval. | 1–2h engineering plus deployment-owner wait | Engineering plus deployment decision |
| Provider and durability matrix | PGlite/FDB-RustFS functional paths green; Ozone performance gate open | 75% for qualified functional scope / 0% for unapproved providers | Manual run [35630660185](https://github.com/andymac4182/mount-rs/actions/runs/35630660185) passed FoundationDB/RustFS [106435785015](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785015), including durable chunk/reopen, service restart, configured FUSE, N-API, and cleanup markers. Ozone lifecycle/composition checks completed and artifacts were retained, but its hard performance rows failed: 35.91 and 59.25 IOPS in `ozone-compositions` [106435785214](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785214), 14.69 in Ozone/TiDB [106435785095](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785095), and 7.50 in Ozone/FoundationDB [106435785295](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785295), each versus 1,000. | Obtain a release-owner decision that Ozone is out of launch scope or remediate/qualify the 1,000-IOPS requirement with provider owners; retain explicit R2/TiDB/RustFS credential/service skips where not configured. | 1–4h engineering/provider work plus hosted wait | External provider/performance gate |
...
- [x] The dependent native artifact aggregation and package-distribution
  ...
  supported release outputs. Manual qualification run [35630660185](https://github.com/andymac4182/mount-rs/actions/runs/35630660185)
  passed `aggregate-native` [106442823972](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106442823972)
  for all five native packages and `mount-rs clean consumer install/smoke:
  PASS`; Windows Node [106435785382](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785382)
  retained `native-win32-x64-msvc.zip` artifact `10654064663` with SHA-256
  `e59a4cde188be1d0254b556d5bda29b3d430e5c9a219d19ed6874114d5ad6fb4`.
...
| W04 production native package and clean-consumer gate | **Complete — current production candidate** | **100%** | Manual run [35630660185](https://github.com/andymac4182/mount-rs/actions/runs/35630660185) passed Windows Node distribution in job [106435785382](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785382), uploaded `native-win32-x64-msvc.zip` artifact `10654064663` with SHA-256 `e59a4cde188be1d0254b556d5bda29b3d430e5c9a219d19ed6874114d5ad6fb4`, and passed five-package `aggregate-native` plus clean-consumer validation in job [106442823972](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106442823972). | Retain the exact artifact/hash in the release record; production release remains NO-GO until persistence/rollback, provider scope, operations, ownership, and the Ubuntu Rust gate close. | 0.25h evidence publication; 0h package implementation | Hosted/package gate |
...
| W04 production-candidate hosted qualification | Partial — Node/package/FDB-RustFS gates green; Ozone performance and Ubuntu FUSE CI gates open | 95% | Manual run [35630660185](https://github.com/andymac4182/mount-rs/actions/runs/35630660185) passed Linux [106435785499](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785499), ARM [106435785258](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785258), macOS-latest [106435785811](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785811), and macOS-15-intel [106435785693](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785693) exact PGlite/restart steps; the macOS logs show SDK/CLI `fail=0`, PGlite-inclusive trace `PASS`, `providersFailed: 0`, backup/restore/rollback PASS, and explicit credential/service skips. Windows package [106435785382](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785382), aggregate/package/clean-consumer [106442823972](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106442823972), and FoundationDB/RustFS [106435785015](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785015) passed. The overall run remains failure because Ozone provider thresholds failed and Ubuntu Rust job [106435785333](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785333) failed four FUSE lifecycle tests. | Diagnose/fix the Ubuntu FUSE failures, decide whether Ozone is in launch scope, and either remediate/qualify its 1,000-IOPS requirement or explicitly exclude it with release-owner approval; retain NO-GO until production gates close. | 1–3h engineering/scope work plus hosted/provider wait |
| W04 credential-free PGlite-only launch-config policy | Complete — implementation and terminal current-tip dedicated hosted workflow | 100% implementation / 100% current-tip policy workflow | `scripts/verify-w04-pglite-production-config.mjs` validates an absolute normalized mountpoint, splitstore PGlite metadata/blocks, durable providers, external `MOUNT_RS_PGLITE_URL` references, distinct scoped volume keys, bounded chunking, owner metadata, and fail-closed unknown/inline-secret cases. The positive and two negative fixtures passed locally, the positive fixture passed the CLI `--check` parser without opening a provider, and the current-tip dedicated non-cancelling run [35629439034](https://github.com/andymac4182/mount-rs/actions/runs/35629439034), job [106431854955](https://github.com/andymac4182/mount-rs/actions/runs/35629439034/job/106431854955), completed successfully with `W04_PGLITE_PRODUCTION_CONFIG_POLICY_PASS`, `metadata.durable-must-be-true`, and `connection.password-must-not-be-inline`. The earlier embedded and dedicated runs remain corroborating evidence only. | Bind the actual PGlite server data directory, version policy, backup/restore, rollback, RPO/RTO, and owners to a deployment; this policy is shape-only. | 0.25h evidence retention; deployment review external | Production config gate |
...
| W04 native R2 key path in configuration-driven FoundationDB/RustFS test | Complete — current hosted confirmation; production provider scope pending | 100% implementation / 100% current hosted qualification | Manual run [35630660185](https://github.com/andymac4182/mount-rs/actions/runs/35630660185), FoundationDB/RustFS job [106435785015](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785015), passed the relative-key configuration path, durable chunk/reopen checks, configured FUSE mount/reopen, N-API bounded readdir, service restart, and cleanup markers after `d07c711` and the rootmode packet. | Keep the provider as an explicit launch-scope decision; this hosted result does not establish customer production credentials, replication, backup, or DR. | 0.25h evidence retention; external provider/owner gate |
| W04 macOS early-rejection socket EPIPE guard | Complete — current hosted confirmation | 100% | Intel job [106435785693](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785693) passed fragmented early rejection and the exact PGlite/restart step after commit `41d5514`; the long trace and PGlite run completed without the historical underlying-socket EPIPE. | None for the published socket guard; retain the hosted log in the release record. | 0h remaining |
| W04 privileged Linux FUSE `rootmode` boundary | Complete — current hosted confirmation | 100% implementation / 100% current hosted qualification | FoundationDB/RustFS job [106435785015](https://github.com/andymac4182/mount-rs/actions/runs/35630660185/job/106435785015) passed `cli_foundationdb_rustfs_config_binary_mounts_and_reopens`, `FOUNDATIONDB_CLI_PASS`, N-API bounded readdir, service restart, and RustFS cleanup after `a55bd64`, `aa3dae3`, and `9ef982d`. | None for the rootmode/config-mount fix; provider production scope and performance thresholds remain separate gates. | 0h remaining |
...
4. [x] Require the dependent native artifact aggregation/package checks and a
   ...
   decision to GO; manual run `35630660185`, aggregate job `106442823972`,
   Windows artifact `10654064663`, and its clean-consumer step satisfy the
   hosted qualification package gate. The production decision remains NO-GO
   for the independent persistence, provider, operations, Rust, and release
   gates.
...
11. [x] Complete manual current-head run `35630660185` from source `42f83bd`;
    Linux, ARM, macOS-latest, and macOS-15-intel exact PGlite/restart steps,
    Windows packaging, aggregate-native, clean-consumer, and corrected
    FoundationDB/RustFS provider evidence all passed. The run is still not a
    production qualification because its configured Ozone IOPS rows failed
    and its Ubuntu Rust job failed four FUSE lifecycle tests. Runs
    `35617849558`, `35619576365`, and the earlier `35620669973` remain useful
    historical/diagnostic evidence but do not override the latest terminal
    result. Queued, skipped, cancelled, partial, or pre-fix evidence does not
    count.
12. [ ] The corrected FoundationDB/RustFS configuration-driven mount now
    passes in job `106435785015`, but the Ozone 1,000-IOPS threshold remains a
...
13. [ ] Diagnose and correct the four Ubuntu Rust FUSE lifecycle failures in
    manual run `35630660185`, then rerun the full post-tip repository gate.
...
| Current Intel socket EPIPE requalification | Complete; manual run `35630660185` exact early-rejection and PGlite/restart steps passed | Hosted/native gate; 0h remaining |
...
| Native artifact aggregation and clean consumer smoke | Complete in current run `35630660185` (`aggregate-native` job `106442823972`); 0.25h release-record retention remains | Hosted/package gate |
...
| Privileged Linux FUSE `rootmode` correction and hosted confirmation | Complete; manual run `35630660185` passed configured FUSE mount/reopen and restart markers | Engineering fix plus hosted native/provider evidence; `a55bd64` masks `rootmode` to `S_IFMT`, `aa3dae3` separates privileged helper metadata, and `9ef982d` aligns the assertion |
| Ozone composition IOPS threshold | Open; manual run `35630660185` measured 35.91 and 59.25 in `ozone-compositions`, 14.69 in Ozone/TiDB, and 7.50 in Ozone/FoundationDB versus target 1,000; 0.5–2h to benchmark/remediate or obtain scope decision | External provider/performance gate; functional lifecycle and cleanup passed |
| FoundationDB/RustFS configuration-driven FUSE requalification | Complete for current hosted path; 0h engineering remaining, production provider scope still open | Provider/native gate; current job `106435785015` passed relative-key, configured mount/reopen, N-API, service restart, and cleanup evidence |
| Credential-free PGlite-only launch-config policy | Complete; current-tip dedicated run `35627894548` passed; 0.25h evidence retention remaining | Hosted policy shape is green, but no provider connection, production data directory, backup, or owner approval was used |
...
| Full post-tip repository CI confirmation | Open; manual run `35630660185` was protected from cancellation but its Ubuntu Rust job failed four FUSE lifecycle tests (`privileged_mount_data_masks_root_permissions`, `positional_reads_run_in_parallel_with_bounded_session_state`, `session_panic_closes_state_and_reports_one_owned_task_error`, and `stop_cancels_an_inflight_request_and_closes_without_transport_error`); 0.5–2h diagnosis/fix plus hosted rerun | Hosted/full-repository release gate |
...
Node/package evidence from manual run `35630660185`, the exact Windows artifact
and clean-consumer result, corrected FoundationDB/RustFS/rootmode qualification,
the cross-platform Fault Injection pass `35620669906`, and the retained Ozone
performance artifacts and thresholds. The manually dispatched run was protected
from unrelated mainline cancellation by the workflow concurrency/dispatch
changes in `2c071e8` and `42f83bd`; all four Node platforms passed the exact
PGlite/restart step, both macOS logs retained PGlite/chunked-PGlite trace PASS,
`providersFailed: 0`, backup/restore/rollback PASS, and smoke artifacts. It
also records the terminal Ozone measurements and the four Ubuntu FUSE lifecycle
test failures; neither the provider threshold failure nor the current Rust gate
is silently promoted to a production pass. This revision also records the new
credential-free PGlite-only launch-config policy and its local positive/negative
evidence; the dedicated non-cancelling policy workflow passed its exact markers.
The local disk-backed `PGLITE_BACKUP_RESTORE_ROLLBACK_PASS` rehearsal remains
supporting evidence only: it is not a production backup or rollback approval.
...
Ozone launch scope/performance, the Ubuntu FUSE gate, deployment-specific
persistence/backup/rollback, observability, runbook execution, ownership, and
