...
| Field | Current value |
| --- | --- |
| Snapshot base revision | `e0ab07d6` (current `origin/main` at this ledger update; includes the published W04 peer-fault test hardening `093565d9`, terminal qualification evidence, and concurrent unrelated mainline work) |
...
| Latest published repository revision | `e0ab07d6` (current `origin/main`; W04 peer-fault hardening `093565d9` and terminal qualification evidence are ancestors, with unrelated mainline commits preserved) |
...
| Snapshot time | 2026-09-22 07:20 AEST |
