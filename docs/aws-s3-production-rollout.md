...
14-day artifact. The latest run [`35625182517`](https://github.com/andymac4182/mount-rs/actions/runs/35625182517)
at `6393b4c` passed provenance capture and all four synthetic contract suites,
...
`aws-s3-qualification-35625182517-1` (6,846 bytes). This artifact is available for a
