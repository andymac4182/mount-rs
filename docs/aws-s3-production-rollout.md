...
14-day artifact. The latest run [`35624389197`](https://github.com/andymac4182/mount-rs/actions/runs/35624389197)
at `2a711e9` passed provenance capture and all three synthetic contract suites,
...
`aws-s3-qualification-35624389197-1` (6,797 bytes). This artifact is available for a
