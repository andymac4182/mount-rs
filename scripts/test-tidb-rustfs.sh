...
export MOUNT_RS_TIDB_COMPOSITION_COMMAND="${MOUNT_RS_TIDB_COMPOSITION_COMMAND:-$repo_dir/scripts/test-tidb-rustfs-consumers.sh}"
export MOUNT_RS_TIDB_CONSUMER_RUN_ID="${MOUNT_RS_TIDB_CONSUMER_RUN_ID:-$run_token}"
