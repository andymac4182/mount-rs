...
const PACKET_SPECS = Object.freeze([
  ...
  },
  {
    ...
    markers: [
      "OZONE_READY ",
      "OZONE_BLOCK_CONTRACT_PASS prefix=",
      "OZONE_FAULT_WINDOW_PASS ",
      "OZONE_GATEWAY_FAILURE_PASS prefix=",
      "OZONE_RESTART_READY ",
      "OZONE_RESTART_REOPEN_PASS prefix=",
      "FOUNDATIONDB_CONFIGURED topology=durable redundancy=double storage=ssd ",
      "FOUNDATIONDB_TRANSACTION_READY ",
      ...
      "FOUNDATIONDB_TEST_PASS topology=durable manifest=providers/mount-rs-foundationdb/Cargo.toml ",
      "OZONE_INTEGRATION_PASS ",
      "OZONE_CLEANUP_PASS ",
    ],
  },
