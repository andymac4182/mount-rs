...
ORDER BY TABLE_NAME, ORDINAL_POSITION;`,
  ...
  'aws-s3': {
    ...
    description: 'The planned AWS path follows the same block-only shape, but the repository has not yet accepted the AWS-specific integration and failure matrix.',
    ...
    entries: [
      ...
      { key: 'mount-rs-tests/owned-run/b0123456789abcdef0123456789abcdef', value: 'intended raw block object', role: 'planned block key' },
      { key: 'mount-rs-tests/owned-run/bfedcba9876543210fedcba987654321', value: 'intended raw block object', role: 'planned block key' },
    ],
    idNote: 'These keys document the intended layout, not completed AWS acceptance. Do not infer a passing AWS backend from R2 or RustFS results.',
  },
  ozone: {
    kind: 'object',
