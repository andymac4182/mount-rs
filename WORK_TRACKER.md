...
`origin/main` is `4a442b23e490f6b7485769d48b6587fc529ec3ba`, including the
...
published at merged tip `4a442b23`, with local full-test/Clippy/security gates
...
- [ ] W26.15 Resolve the terminal per-drive IOPS qualification blocker. The
  ...
  `origin/main` `4a442b23`; the next manual run must select that exact
  revision.
  Preserve fencing,
