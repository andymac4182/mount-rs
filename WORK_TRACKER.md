...
`origin/main` is `47547d367845c96a961f03f5f932dd2977951176`, including the
...
published at merged tip `47547d36`, with local full-test/Clippy/security gates
...
- [ ] W26.15 Resolve the terminal per-drive IOPS qualification blocker. The
  ...
  `origin/main` `47547d36`; the next manual run must select that exact
  revision.
  Preserve fencing,
