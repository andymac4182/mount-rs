...
`origin/main` is `14dbf2c61b5d86606b165692e0ba1e0e7af545dc`, including the
...
published at merged tip `14dbf2c6`, with local full-test/Clippy/security gates
...
- [ ] W26.15 Resolve the terminal per-drive IOPS qualification blocker. The
  ...
  `origin/main` `14dbf2c6`; manual run `35683158821` now selects that exact
  revision.
  Preserve fencing,
