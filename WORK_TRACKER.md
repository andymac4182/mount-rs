...
- [ ] W05.10 Close the production release path on one settled revision.
  ...
  `35714144497` has classified Ozone/TiDB and Ozone/FoundationDB
  hard-capacity failures at `84.01/1000` and `298.61/1000` IOPS, the isolated
  macOS artifact finalization timeout, and remaining provider/native jobs
  incomplete. The prior immutable candidate
