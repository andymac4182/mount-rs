...
`origin/main` is `8c8f678adaf81beda78f092d343ed8585152e500`, including the
...
published at merged tip `8c8f678a`, with local full-test/Clippy/security gates
...
- [ ] W26.15 Resolve the terminal per-drive IOPS qualification blocker. The
  ...
  `origin/main` `8c8f678a`; the next manual run must select that exact
  revision.
  Preserve fencing,
